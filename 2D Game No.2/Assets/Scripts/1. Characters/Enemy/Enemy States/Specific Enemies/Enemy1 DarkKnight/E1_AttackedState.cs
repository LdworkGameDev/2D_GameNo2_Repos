...
public class E1_AttackedState : EnemyAttackedState
{
    private E1_Controller enemyController;

    public E1_AttackedState(EnemyBaseController enemyBaseController_, EnemyData enemyData_, string animParameter_, E1_Controller enemyController_) 
